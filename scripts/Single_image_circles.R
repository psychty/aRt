...
# install.packages(c('imager', 'deldir','colourlovers'))
libraries(c('tidyverse', 'imager', 'scales', 'packcircles', 'deldir', 'colourlovers', 'mgcv', 'sp', 'rgeos'))

github_repo_dir <- "~/Documents/GitHub/aRt"
# github_repo_dir <- "~/GitHub/aRt"
output_directory_x <- paste0(github_repo_dir, '/Outputs')

img <- load.image(paste0(github_repo_dir, '/images/Jake_red_hat.jpg'))
